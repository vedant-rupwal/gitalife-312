...
import { Building2, Calendar, BookOpen, BarChart3, Loader2 } from "lucide-react";
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="flex flex-wrap gap-2 mb-8">
          {tabs.map((t) => {
            const Icon = t.icon;
            return (
              <button key={t.id} onClick={() => setTab(t.id)} className={cn("flex items-center gap-2 rounded-xl px-5 py-3 font-heading text-sm font-semibold transition-all", tab === t.id ? "bg-navy text-white" : "bg-white text-navy/60 border border-navy/8 hover:bg-navy/5")}>
